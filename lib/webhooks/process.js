...
async function handleOrderUpsert(store, payload) {
  ...
  // Enrollment happens here in phase 3. It is deliberately absent rather than
  // stubbed: an enrollment call that silently does nothing is worse than one
  // that does not exist, because it reads as working.
